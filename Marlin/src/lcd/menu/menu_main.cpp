...
void menu_main() {
  ...
  if (busy) {
    ...
    GCODES_ITEM(MSG_STAIN_DRAGON_WOLF_4_4, F("M1399"));
    GCODES_ITEM(MSG_STAIN_DRAGON_WOLF_1_4, F("M1398"));
    GCODES_ITEM(MSG_STAIN_DRAGON_WOLF_1_1, F("M1397"));
    GCODES_ITEM(MSG_PARK_BATH, F("M1209"));
    GCODES_ITEM(MSG_UNPARK, F("M1219"));
    GCODES_ITEM(MSG_PURGE_STAIN, F("M1199"));
    GCODES_ITEM(MSG_EXTRUDE_MEDIUM_STAIN, F("M1249"));
    GCODES_ITEM(MSG_PRIME_STAIN, F("M1299"));
    GCODES_ITEM(MSG_REFILL_SYRINGE, F("M1396"));
    GCODES_ITEM(MSG_LEVEL_JIG_HOLDERS, F("M1099"));
